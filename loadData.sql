...
WHERE NOT EXISTS(SELECT * FROM FRIENDS 
	WHERE U.USER2_ID=FRIENDS.USER1_ID AND U.USER1_ID=FRIENDS.USER2_ID
	) 
AND NOT EXISTS(SELECT USER_ID FROM USERS 
	WHERE U.USER1_ID=USERS.USER_ID AND U.USER2_ID=USERS.USER_ID
);
